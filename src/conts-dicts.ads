...
package Conts.Dicts is
   ...
   package Generic_Dicts is
      ...
      function Value (Self : Dict; Position : Cursor) return Value_Type with Inline;

      function Key (Self : Dict; Position : Cursor) return Key_Type with Inline;

      function First (Self : Dict) return Cursor;

      function Next (Self : Dict; Position : Cursor) return Cursor;

      function Has_Element (Self : Dict; Position : Cursor) return Boolean with Inline;
